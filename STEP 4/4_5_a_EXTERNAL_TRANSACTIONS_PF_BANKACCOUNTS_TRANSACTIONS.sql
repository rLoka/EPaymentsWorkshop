...
INSERT INTO PF_BANKACCOUNTS_TRANSACTIONS (PO_ID, ACCOUNT_ID, BANK_ID, TRANSACTION_DATE, TRANSACTION_TIME, TRANSACTION_PURPOSE, TRANSACTION_AMOUNT) SELECT PO_ID, DB_ACCOUNT_ID, DB_BANK_ID, TO_CHAR(SYSDATE, 'YYYYMMDD'), TO_CHAR(SYSDATE, 'HHMISS'), PO_PURPOSE, PO_AMOUNT FROM PF_PO_OUTBOX WHERE (SB_BANK_ID = 'SABA' AND DB_BANK_ID != 'SABA');
...
--Log
INSERT INTO PF_LOG (LOG_DATE, LOGTIME, LOG_USER, LOG_ACTION, LOG_COMMENT) VALUES (TO_CHAR(SYSDATE, 'YYYYMMDD'), TO_CHAR(SYSDATE, 'HHMISS'), 'MAR', 'Process external transactions.', 'Process external transactions - SABA to OTHERS.')
